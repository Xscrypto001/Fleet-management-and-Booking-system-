...
from . import views
from .views import UsernamesStringView,AvailableRoutesView,BookingListView,mark_booking_as_paid
...
urlpatterns = [
    ...
    path("api/bookings/<int:booking_id>/mark-paid/", views.mark_booking_as_paid, name="mark-booking-paid"),
   path('api/history/', BookingListView.as_view(), name='booking-list'),
    ...
    path('api/usernames/', UsernamesStringView.as_view(), name='usernames'),
